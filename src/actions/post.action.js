...
export const LIKES_POST = "LIKES_POST";
...
export const likeButton = (data, postId) => {
  return (dispatch) => {
    
    return updateDoc(doc(db, "posts", postId), { likes: data.likes})
      .then(() => {
        dispatch({ type: LIKES_POST, payload: { ...data } });
      })
      .catch((err) => console.log(err));
  };
};
